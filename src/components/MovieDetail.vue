        ...
        <v-container>
            <v-row>
                ...
                <v-col cols="12" sm="8">
                    ...
                    <span class="blue--text">Detail Movie</span>
                    <v-row>
                        <v-col cols="12" sm="2">
                            <v-rating
                    ...
                    >
                        ...
                        <v-btn tile color="blue" v-bind="attrs" v-on="on" @click.prevent="openYoutubeModel">
                            <v-icon left color="white">mdi-play</v-icon><h4 class="colourText">Play</h4>
                        </v-btn>
                    </template>
                    <v-card>
                        <v-card-title>
                    ...
                    <v-btn tile color="blue" class="ml-2">
                        <v-icon left color="white">mdi-play</v-icon><h4 class="colourText">Watchlist</h4>
                    </v-btn>
                </v-col>
            </v-row>
